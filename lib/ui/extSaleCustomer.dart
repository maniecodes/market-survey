...
class ExtSaleCustomerPage extends GetView<BorrowingController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: controller.extSalescaffoldKey,
      appBar: AppBar(
        backgroundColor: Theme.of(context).primaryColor,
        elevation: 0.0,
        title: Text(
          'Credit Sale Exisitng Customer',
